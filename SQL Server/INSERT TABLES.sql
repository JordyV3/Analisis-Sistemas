...
INSERT INTO MENU(Nombre,Icono) VALUES ('Administrador',' fas fa-users-cog'),('Compras',' fa fa-shopping-basket'),('Ventas',' fa fa-tags'),('Reportes',' fa fa-tasks')
...
values('Jordy','Vega','jordyvega15@gmail.com','Admin','Admin123',(select TOP 1 IdTienda from TIENDA where Nombre = 'Tienda 001'),(select TOP 1 IdRol from ROL where Descripcion = 'ADMINISTRADOR'))
go
insert into usuario(Nombres,Apellidos,Correo,Usuario,Clave,IdTienda,IdRol)
values('Alexander','Aldana','alexA@gmail.com','Tienda','Tienda123',(select TOP 1 IdTienda from TIENDA where Nombre = 'Tienda 001'),(select TOP 1 IdRol from ROL where Descripcion = 'EMPLEADO'))
